...
public class DistributorMatchingAcitivity extends BaseActivity implements OnClickListener, RequestListener, OnRefreshListener<ListView> {
    ...
    private void initData() {
        mTxtTitle.setText(R.string.distributor_matching_title);
    ...
    private void initView() {
        ...
        mAdapter = new DistributorMatchingAdapter(this);
    }
