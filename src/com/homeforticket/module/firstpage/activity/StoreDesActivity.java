...
public class StoreDesActivity extends BaseActivity implements OnClickListener, RequestListener {
    ...
    private void setStoreInfo() {
        ...
        try {
            ...
            jsonObject.put("description", mEditText.getText().toString().trim());
