...
import com.homeforticket.module.firstpage.adapter.DistributorSettingAdapter;
...
public class DistributorSettingAcitivity extends BaseActivity implements OnClickListener, RequestListener, OnRefreshListener<ListView> {
    ...
    private DistributorSettingAdapter mAdapter;
    ...
    private void initData() {
        mTxtTitle.setText(R.string.distributor_setting_title);
    ...
    private void initView() {
        ...
        mAdapter = new DistributorSettingAdapter(this);
    }
