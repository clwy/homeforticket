...
public class StoreAddressActivity extends BaseActivity implements OnClickListener, RequestListener {
    ...
    private void setStoreInfo() {
        ...
        try {
            ...
            jsonObject.put("description", mStoreStatisticsMessage.getAddress());
            jsonObject.put("address", mEditText.getText().toString().trim());
