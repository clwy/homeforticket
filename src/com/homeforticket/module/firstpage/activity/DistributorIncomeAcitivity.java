...
import com.homeforticket.module.firstpage.adapter.DistributorIncomeAdapter;
...
public class DistributorIncomeAcitivity extends BaseActivity implements OnClickListener, RequestListener, OnRefreshListener<ListView> {
    ...
    private DistributorIncomeAdapter mAdapter;
    ...
    private void initData() {
        mTxtTitle.setText(R.string.distributor_income_title);
    ...
    private void initView() {
        ...
        mAdapter = new DistributorIncomeAdapter(this);
    }
