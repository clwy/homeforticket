...
import com.homeforticket.module.firstpage.adapter.DistributorOrderAdapter;
...
public class DistributorOrderAcitivity extends BaseActivity implements OnClickListener, RequestListener, OnRefreshListener<ListView> {
    ...
    private DistributorOrderAdapter mAdapter;
    ...
    private void initData() {
        mTxtTitle.setText(R.string.distributor_order_title);
    ...
    private void initView() {
        ...
        mAdapter = new DistributorOrderAdapter(this);
    }
