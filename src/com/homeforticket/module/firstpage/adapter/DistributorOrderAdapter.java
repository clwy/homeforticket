...
public class DistributorOrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.list_item_distributor_order, parent, false);
            ...
            holder.check = (Button) convertView.findViewById(R.id.check_button);
