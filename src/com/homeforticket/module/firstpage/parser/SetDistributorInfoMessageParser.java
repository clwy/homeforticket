...
public class SetDistributorInfoMessageParser extends AbstractParser<SetDistributorInfoMessage> {
   
    @Override
    public SetDistributorInfoMessage parseInner(String parser) throws Exception {

        SetDistributorInfoMessage message = new SetDistributorInfoMessage();
